...
const Middle = () => {
  ...
  return (
    <div className="flex justify-between">
      ...
      <Button type="button" onClick={() => openModal()} className="modal-open mx-auto lg:mx-4 font-extrabold focus:outline-none rounded my-1 mr-3 md:my-1 py-2 px-8 shadow-lg w-48">
        Add Tool
      </Button>
